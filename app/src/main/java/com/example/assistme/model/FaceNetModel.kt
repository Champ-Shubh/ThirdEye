...
class FaceNetModel(private var context: Context, var model: ModelInfo, var useGPU: Boolean) {
    ...
    private fun runFaceNet(inputs: Any): Array<FloatArray> {
        ...
        Log.d("Performance", "${model.name} Inference Speed in ms : ${System.currentTimeMillis() - t1}")
